...
from tkinter import Label, Button, Tk, END, Text, StringVar, Entry, OptionMenu
...
tab1 = tk.Frame(tab_control, bg='#333333')
tab2 = tk.Frame(tab_control, bg='#333333')
tab3 = tk.Frame(tab_control, bg='#333333')
tab4 = tk.Frame(tab_control, bg='#333333')
...
# Labels
label1 = Label(tab1, text='Summaryzer', padx=5, pady=5, fg='white', bg='#333333')
label1.grid(column=0, row=0)

label2 = Label(tab2, text='File Processing', padx=5, pady=5, fg='white', bg='#333333')
label2.grid(column=0, row=0)

label3 = Label(tab3, text='URL', padx=5, pady=5, fg='white', bg='#333333')
label3.grid(column=0, row=0)

label4 = Label(tab4, text='Compare Summarizers', padx=5, pady=5, fg='white', bg='#333333')
...
def openfiles():
    ...
    displayed_file.insert(END, read_text)

def get_file_summary():
    raw_text = displayed_file.get('1.0', END)
    final_text = text_summarizer(raw_text)
    result = '\nSummary:{}'.format(final_text)
...
def get_url_summary():
    ...
    final_text = text_summarizer(raw_text)
    result = '\nSummary:{}'.format(final_text)
    tab3_display_text.insert(END, result)

def use_spacy():
    raw_text = str(entry1.get('1.0', END))
    final_text = text_summarizer(raw_text)
    result = '\nSpacy Summary:{}\n'.format(final_text)
    tab4_display.insert(END, result)
...
# MAIN NLP TAB
l1 = Label(tab1, text="Enter Text To Summarize",background='#333333', fg='white')#, background='black'
l1.grid(row=1, column=0)

entry = Text(tab1, height=10, bg='#444444', fg='white')
...
tab1_display = Text(tab1, bg='#444444', fg='white')
tab1_display.grid(row=7, column=0, columnspan=3, padx=5, pady=5)

# FILE PROCESSING TAB
l1 = Label(tab2, text="Open File To Summarize",background='#333333', fg='white')# background='black'
l1.grid(row=1, column=1)

displayed_file = ScrolledText(tab2, height=7, bg='#444444', fg='white')
displayed_file.grid(row=2, column=0, columnspan=3, padx=5, pady=3)

# BUTTONS FOR FILE READING TAB
b0 = Button(tab2, text="Open File", width=12, command=openfiles, bg='#c5cae9', fg='black')
b0.grid(row=3, column=0, padx=10, pady=10)

b1 = Button(tab2, text="Reset", width=12, command=clear_text_file, bg="#b9f6ca", fg='black')
...
b4 = Button(tab2, text="Close", width=12, command=window.destroy, bg='#f44336', fg='white')
b4.grid(row=5, column=2, padx=10, pady=10)

# Display Screen
tab2_display_text = ScrolledText(tab2, height=10, bg='#444444', fg='white')
tab2_display_text.grid(row=7, column=0, columnspan=3, padx=5, pady=5)

# URL TAB
l1 = Label(tab3, text="Enter URL To Summarize",background='#333333', fg='white')#, background='black'
l1.grid(row=1, column=0)

raw_entry = StringVar()
url_entry = Entry(tab3, textvariable=raw_entry, width=50, bg='#444444', fg='white')
...
# Display Screen
url_display = Text(tab3, height=10, bg='#444444', fg='white')
url_display.grid(row=6, column=0, columnspan=3, padx=5, pady=5)

tab3_display_text = ScrolledText(tab3, height=10, bg='#444444', fg='white')
tab3_display_text.grid(row=7, column=0, columnspan=3, padx=5, pady=5)

# COMPARER TAB
l1 = Label(tab4, text="Enter Text To Compare Summarizers",background='#333333', fg='white')#, background='black'
l1.grid(row=1, column=0)

entry1 = Text(tab4, height=10, bg='#444444', fg='white')
...
button3 = Button(tab4, text="NLTK", command=use_nltk, width=12, bg='#03A9F4', fg='#fff')
button3.grid(row=5, column=0, padx=10, pady=10)
...
# Display Screen For Compare Result
tab4_display = Text(tab4, height=10, bg='#444444', fg='white')
tab4_display.grid(row=7, column=0, columnspan=2, padx=5, pady=5)
...
# Core Packages
import tkinter as tk
from tkinter import Label ,Button,Tk,END,Text,NORMAL,StringVar,Entry,OptionMenu
from tkinter import ttk
